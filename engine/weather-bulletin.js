 ...
 * Status: Equidistant Sampling + Shared State + KM/H 
 */
...
const WeatherEngine = (function() {
    const state = {
        ...
        isOpen: false,
        communities: [],
        activeWaypoints: [], // Central Source of Truth
        nodes: [0.15, 0.35, 0.55, 0.75, 0.95] // Consistent spacing
    };

    // 1. Initial Data Load (Targeting your NL subdirectory)
    const init = async () => {
        try {
            ...
            // Fail-safe baseline for Newfoundland coverage
            state.communities = [
    ...
    // 2. Variation Engine (Shared across UI and Map)
    ...
    // 4. Shared Sync Logic (Calculates waypoints once for both Icon and Table)
    const syncCycle = async () => {
        ...
        // Calculate the unified waypoint data
